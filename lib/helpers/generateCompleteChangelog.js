...
const writeBackup = () => {
  ...
  try {
    ...
    console.warn(chalk.red('Error: could not create a backup of the CHANGELOG.md...'));
  }
};
...
const backupChangelog = () => {
  ...
  try {
    ...
    return console.warn(chalk.red('Error: could not check if  directory \'.sgr_backup\' exists...'));
  }
};
